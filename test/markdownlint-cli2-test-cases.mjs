 ...
 * @property {(fromDir: string, toDir: string) => Promise<void>} copyDir Function to copy a directory.
 * @property {(dir: string) => Promise<void>} removeDir Function to remove a directory.
 * @property {(file: string, options: "utf8") => Promise<string>} readFile Function to read a file.
